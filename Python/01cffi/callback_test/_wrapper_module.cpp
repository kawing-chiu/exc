...
{
  delete_derived_class(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_delete_derived_class(PyObject *self, PyObject *arg0)
{
  TestClass * x0;
  Py_ssize_t datasize;
...
#else
#  define _cffi_f_delete_derived_class _cffi_d_delete_derived_class
#endif

static void _cffi_d_derived_class_call_callback(TestClass * x0)
{
  derived_class_call_callback(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_derived_class_call_callback(PyObject *self, PyObject *arg0)
{
  TestClass * x0;
  Py_ssize_t datasize;
...
{
  return derived_class_get_attr(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_derived_class_get_attr(PyObject *self, PyObject *arg0)
{
  TestClass * x0;
  Py_ssize_t datasize;
  int result;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = derived_class_get_attr(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_derived_class_get_attr _cffi_d_derived_class_get_attr
#endif

static void _cffi_d_derived_class_set_attr(TestClass * x0, int x1)
{
  derived_class_set_attr(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_derived_class_set_attr(PyObject *self, PyObject *args)
{
  TestClass * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  aa = _cffi_unpack_args(args, 2, "derived_class_set_attr");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
#else
#  define _cffi_f_derived_class_set_attr _cffi_d_derived_class_set_attr
#endif

static void _cffi_d_derived_class_set_callback(TestClass * x0, int(* x1)(TestStruct *))
{
  derived_class_set_callback(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_derived_class_set_callback(PyObject *self, PyObject *args)
{
  TestClass * x0;
  int(* x1)(TestStruct *);
  Py_ssize_t datasize;
  ...
  aa = _cffi_unpack_args(args, 2, "derived_class_set_callback");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
  ...
  x1 = (int(*)(TestStruct *))_cffi_to_c_pointer(arg1, _cffi_type(13));
  if (x1 == (int(*)(TestStruct *))NULL && PyErr_Occurred())
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_new_derived_class(PyObject *self, PyObject *noarg)
{
  TestClass * result;

  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = new_derived_class(); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_new_derived_class _cffi_d_new_derived_class
#endif

_CFFI_UNUSED_FN
static void _cffi_checkfld__TestStruct(TestStruct *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { char(*tmp)[20] = &p->text; (void)tmp; }
  { double *tmp = &p->num; (void)tmp; }
}
struct _cffi_align__TestStruct { char x; TestStruct y; };
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__wrapper_module(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__wrapper_module(void) { return NULL; }
#  else
     init_wrapper_module(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__wrapper_module(void)
{
  return _cffi_init("_wrapper_module", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_wrapper_module(void)
{
  _cffi_init("_wrapper_module", 0x2601, &_cffi_type_context);
}
#endif
